...
public class LoginSessions extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sID = Integer.toString(student.getId());
...
return;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// and comparing the submitted credentials against each student's email and
		// password
		@SuppressWarnings("unchecked")
		ArrayList<Student> students = (ArrayList<Student>) getServletContext().getAttribute("students");
		...
		for (Student student : students) {
			if (student.getEmail().toLowerCase().equals(username.trim().toLowerCase())
					&& student.getPassword().equals(password) && rememberMe != null) {
				...
				Cookie cookie = new Cookie("student", value);
				...
				response.sendRedirect("MyProfile");
				return;
			} else if (student.getEmail().toLowerCase().equals(username.trim().toLowerCase())
		...
		// if we get here then we couldn't find a Student that matched the submitted
		// credentials
