 ...
 */
@WebServlet("/midterm/TutorAdmin")
public class TutorAdmin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<tr>");
		out.println("  <th>Name</th><th>Email</th><th>Course Taught</th><th>Actions</th>");
		out.println("</tr>");
		...
		out.println("<a class=\"btn btn-primary\" href=\"TutorProfile\">Non-Admin site</a>");
